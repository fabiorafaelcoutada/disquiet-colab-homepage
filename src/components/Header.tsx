...
export default function Header() {
  ...
  return (
    <header className="bg-white shadow-md">
      <nav className="container mx-auto px-6 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <a href="https://www.linkedin.com/company/disquiet-colab" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile">
            ...
            <a href="https://github.com/disquiet-colab" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 px-3 py-2">GitHub</a>
            <div className="relative" onMouseEnter={() => setCompanyOpen(true)} onMouseLeave={() => setCompanyOpen(false)}>
              <button className="text-gray-600 hover:text-gray-900 px-3 py-2">Company</button>
              {companyOpen && (
      ...
      <nav className="container mx-auto px-6 py-3 border-t border-gray-200">
